...
export const defaultLayoutSections: LayoutSection[] = [
  ...
  },
  {
    ...
    key: 'metrics',
    name: 'Metric Cards',
    description: 'Operational metrics, statistics cards, and image burst uploads.',
    visible: true,
    order: 6,
    heading: 'OPERATIONAL METRICS',
    subheading: 'Key studio achievements and metric stats.',
    metricsData: [],
    bgStyle: 'dark',
    spacing: 'default',
    animationEnabled: true,
  ...
  },
  {
    ...
    key: 'footer',
    name: 'Footer & CTA Bar',
    description: 'Global footer banner with contact trigger and navigation links.',
    visible: true,
    order: 8,
    heading: 'INITIATE TRANSMISSION',
    subheading: 'Ready to construct your digital monument?',
